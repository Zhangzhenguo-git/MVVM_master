package com.example.mvvm_master.http;
...
import com.example.mvvm_master.http.retrofitinterface.RetrofitInterface;
...
public class HttpUtils {
    ...
    //获取新闻数据
    public static Observable<User> login(String userName, String userPwd) {
        return getRetrofit().login(userName,userPwd);
    }
}
